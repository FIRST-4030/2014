...
public interface ListIterator {
     ...
     * call to {@code next}, or list size if the list iterator is at the end of
     * the list
     */
    int nextIndex();
     ...
     *
     * @return the index of the element that would be returned by a subsequent
     * call to {@code previous}, or -1 if the list iterator is at the beginning
     * of the list
     */
    int previousIndex();
     ...
     * made once per call to {@code next} or {@code previous}. It can be made
     * only if {@link #add} has not been called after the last call to
     ...
     * only if neither {@link #remove} nor {@link
